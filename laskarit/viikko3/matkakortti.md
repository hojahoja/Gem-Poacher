...
```mermaid
 sequenceDiagram
    ...
    laitehallinto ->> laitehallinto : lukijat.append(rautatietori)
    deactivate laitehallinto
    main ->> laitehallinto : lisaa_lukija(ratikka6)
    activate laitehallinto
    laitehallinto ->> laitehallinto : lataajat.append(ratikka6)
    deactivate laitehallinto
    main ->> laitehallinto : lisaa_lukija(bussi244)
    activate laitehallinto
    laitehallinto ->> laitehallinto : lataajat.append(bussi244)
    deactivate laitehallinto
