...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortille_ei_voi_ladata_rahaa_negatiivisella_arvolla(self):
        self.kortti.lataa_rahaa(-100)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_syo_edullisesti_toimii_pienimmalla_mahdollisella_saldolla(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0)

    def test_syo_maukkaasti_toimii_pienimmalla_mahdollisella_saldolla(self):
